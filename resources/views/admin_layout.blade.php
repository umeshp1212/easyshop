			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-manufacture')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">All Manufacture</span></a></li>
						<li>
						...
						<li><a href="{{URL::to('/add-contact')}}"><i class="icon-font"></i><span class="hidden-tablet">Add Contact</span></a></li>
						<li><a href="{{URL::to('/all-inquiry')}}"><i class="icon-picture"></i><span class="hidden-tablet">Customer Inquiry</span></a></li>
