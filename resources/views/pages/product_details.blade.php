...
<div class="col-sm-7">
    <div class="product-information"><!--/product-information-->
        <img src="{{URL::to('front-end/images/product-details/new.jpg')}}" class="newarrival" alt="" />
        <h2>{{$product_by_details->product_name}}</h2>
        <p>Web ID: {{$product_by_details->product_id}}</p>
        <img src="{{URL::to('front-end/images/product-details/rating.png')}}" alt="" />
        <span>
        ...
        <a href=""><img src="{{URL::to('front-end/images/product-details/share.png')}}" class="share img-responsive"  alt="" /></a>
    ...
    <div class="tab-pane fade active in" id="reviews" >
        <div class="col-sm-12">
            ...
            <form action="#">
                ...
                <b>Rating: </b> <img src="{{URL::to('front-end/images/product-details/rating.png')}}" alt="" />
