    ...
    <div class="product-image-wrapper">
        <div class="single-products">
                <div class="productinfo text-center">
                    <img src="{{URL::to($v_product_by_category->product_image)}}" alt="{{$v_product_by_category->product_image}}" />
                    <h2>Rs {{$v_product_by_category->product_price}}</h2>
                    <a href="{{URL::to('/view-product/'.$v_product_by_category->product_id)}}"><p>{{$v_product_by_category->product_name}}</p></a>
                    <a href="{{'/view-product/'.$v_product_by_category->product_id}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                </div>
        ...
        <div class="choose">
            <ul class="nav nav-pills nav-justified">
                <li><a href="{{'/product-by-manufacture/'.$v_product_by_category->manufacture_id}}"><i class="fa fa-plus-square"></i>{{$v_product_by_category->manufacture_name}}</a></li>
                <li><a href="{{'/view-product/'.$v_product_by_category->product_id}}"><i class="fa fa-plus-square"></i>View Product</a></li>
            </ul>
        </div>
    </div>
</div>
...
@endforeach
@else 
    <p class="text-center alert-danger">No product found in this category </p>; 
@endif
