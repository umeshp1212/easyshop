        ...
        <div class="box-content">
            <form class="form-horizontal" action="{{url('/update-product','product_info->product_id')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="control-group hidden-phone">
                    ...
                    <div class="controls">
                    <textarea class="cleditor" rows="1" name="product_short_description" value="{{$product_info->product_short_description}}"></textarea>
                    </div>
                </div>
                ...
                <div class="control-group hidden-phone">
                    ...
                    <div class="controls">
                    <textarea class="cleditor" rows="3" name="product_long_description" value="{{$product_info->product_long_description}}"></textarea>
                    </div>
                </div>
