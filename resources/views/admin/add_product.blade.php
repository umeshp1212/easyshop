        ...
        <div class="box-content">
            <form class="form-horizontal" action="{{url('/save-product')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="control-group hidden-phone">
                    ...
                    <div class="controls">
                    <textarea class="cleditor" rows="1" name="product_short_description" required=""></textarea>
                    </div>
                </div>
                ...
                <div class="control-group hidden-phone">
                    ...
                    <div class="controls">
                    <textarea class="cleditor" rows="3" name="product_long_description" required=""></textarea>
                    </div>
                </div>
